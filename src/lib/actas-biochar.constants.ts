 ...
 *
 * No son dos variantes cosméticas: los dos son productos de Sirius Inventario
 * Production Core, pero el biochar puro sale de BACHES concretos (es lo que sostiene
 * la trazabilidad de carbono) y el Blend sale de un LOTE `BLEND-…` ya producido.
 */
