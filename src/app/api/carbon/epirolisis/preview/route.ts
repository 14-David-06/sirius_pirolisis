// POST /api/carbon/epirolisis/preview
// Preview del cálculo ePirólisis sin guardar
...
export async function POST(request: NextRequest) {
  try {
    ...
    const useCase = Container.getPreviewEPirolisisUseCase();
    ...
    return handleApiError(error, 'POST /api/carbon/epirolisis/preview');
  }
}
