 ...
 *
 * Esto NO genera remisión ni pedido: no es facturable. El descuento va a Sirius
 * Inventario Production Core —los dos son productos de esa base desde el
 * 2026-08-21—, bache por bache para el biochar puro y contra el lote para el Blend,
 * con el código del acta como llave de idempotencia.
 *
 * Respuestas del POST:
