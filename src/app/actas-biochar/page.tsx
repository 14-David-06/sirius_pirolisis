                    ...
                    <table className="w-full min-w-[46rem] text-sm">
                      <thead>
                        <tr className="text-left text-xs uppercase tracking-wide text-white/45">
                          ...
                          <th scope="col" className="px-5 py-3 font-medium">Firmas</th>
                        </tr>
                      </thead>
                            ...
                            <td className="px-5 py-3">
                              {acta.estado === ESTADO_ACTA.borrador ? (
                                <span className="text-xs text-white/40">
                                  Sin descontar: no se puede firmar
                                </span>
                              ) : acta.estado === ESTADO_ACTA.generada ? (
                                <a
                                  href={`/actas-biochar/${acta.id}/firmar`}
                                  className="text-xs font-medium text-sky-200 underline"
                                >
                                  Falta firma → firmar
                                </a>
                              ) : acta.urlDocumento ? (
                                <a
                                  href={acta.urlDocumento}
                                  target="_blank"
